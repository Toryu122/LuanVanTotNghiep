...
<body>
    ...
    <x-admin.home.header title="Publisher" />
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
                        ...
                        <div class="card-body">
                            <div class="pb-3">
                                <button type="button" class="text-white btn btn-default btn-sm" data-bs-toggle="modal"
                                    ...
                                    <i class="fa-solid fa-plus"></i> Thêm publisher
                                </button>
                            </div>
                                                            ...
                                                            <div class="modal-body text-start text-black p-4">
                                                                <div class="mb-3">
                                                                    <form class="editPublisher"
                                                                        ...
                                                                        <div class="row mb-3">
                                                                            <label class="col-sm-2 col-form-label"
                                                                                for="basic-default-name">Tên nhà phát
                                                                                hành</label>
                                                                            <div class="col-sm-10">
                                                                                <input type="text"
                                                                                    class="form-control"
                                                ...
                                                <div class="modal" id="deleteGame{{ $item->id }}" tabindex="-1">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post"
                                                                action="{{ route('deletepublisher', ['id' => $item->id]) }}">
                                                                @csrf
                                                                @method('delete')
                                                                ...
                                                                <div class="modal-body">
                                                                    <p>Bạn có chắc muốn xóa publisher này?
                                                                    </p>
                                                                </div>
            ...
            <div class="modal fade" id="addPublisherModal" tabindex="-1" aria-labelledby="addRoleModal"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header border-bottom-0">
                        ...
                        <div class="modal-body text-start text-black p-4">
                            <div class="mb-3">
                                <form id="addPublisher" action="{{ route('storepublisher') }}" method="POST">
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="col-sm-10">
                                            <button type="submit" class="btn btn-primary">Thêm publisher</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
